      ...
      <div className='page'>
        <div className='content'>
          <div className='settings'>
            <h3 style={{textAlign: 'center', paddingBottom:'1em'}}>Settings</h3>
            <Form>
              <Form.Group as={Form.Row}>
                <Form.Label column sm={5}>Number of Rounds</Form.Label>
                <Col sm={7}>
              ...
              <Form.Group as={Form.Row}>
                <Form.Label column sm={5}>Drawing Time</Form.Label>
                <Col sm={7}>
                  <InputGroup>  
                      <Form.Control as='select'
                                    disabled={!this.props.isHost}
              ...
              <Form.Group as={Form.Row}>
                <Form.Label column sm={5}>Customs Words</Form.Label>
              ...
              <InputGroup 
                  onMouseOver={ () => { this.setState({roomLinkValue: this.state.roomLink}); } }
                  onMouseOut={ () => { this.setState({roomLinkValue: 'hover to see lobby link'}); } }>
                <Form.Control
                  disabled readOnly
                ...
                <InputGroup.Append>
                  <Button variant="info" onClick={this.handleCopyClicked}>Copy</Button>
                </InputGroup.Append>
              </InputGroup>
            </Form>
          </div> 
          <div className='players'>
            <h3 style={{textAlign: 'center', paddingBottom:'1em'}}>Players</h3>  
            {
              this.state.players.map((player, index) => {
                return(
                  <div key={index} className='player-container'>
                    <img className='player-pfp' src="https://play.nintendo.com/images/profile-kirby-kirby.7bf2a8f2.aead314d58b63e27.png" alt='pfp'></img>
